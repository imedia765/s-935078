...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#221F26]"> {/* Darker background for better contrast */}
      <Navigation />
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <Button 
              ...
              variant="outline" 
              className="bg-black/40 hover:bg-[#8B5CF6]/20 border-[#8B5CF6]/20"
            >
              Sign Out
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              {/* Profile Card with enhanced glass effect */}
              <Card className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-lg shadow-lg hover:shadow-[#8B5CF6]/10 transition-all duration-300">
                <div className="p-6">
                  <div className="flex items-start gap-6">
                    <Avatar className="h-20 w-20 bg-[#8B5CF6]/20">
                      <span className="text-2xl text-[#8B5CF6]">{memberData?.full_name?.[0]}</span>
                    </Avatar>
              ...
              {/* Bank Details with distinct styling */}
              <Card className="bg-[#1E1B21]/80 backdrop-blur-xl border border-[#8B5CF6]/20 rounded-lg shadow-lg">
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Building2 className="text-[#8B5CF6]" />
                    <h2 className="text-xl font-semibold bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text text-transparent">
                      Bank Details
                    </h2>
                  </div>
                  ...
                  <div className="mt-4 p-4 bg-[#8B5CF6]/5 rounded-lg border border-[#8B5CF6]/20">
              ...
              {/* Payment History with enhanced table styling */}
              <Card className="bg-[#1E1B21]/80 backdrop-blur-xl border border-[#8B5CF6]/20 rounded-lg shadow-lg">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <Receipt className="text-[#8B5CF6]" />
                      <h2 className="text-xl font-semibold bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text text-transparent">
                        Payment History
                      </h2>
                    </div>
                  ...
                  <div className="relative overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow className="border-b border-[#8B5CF6]/20">
                          <TableHead className="text-[#8B5CF6]">Date</TableHead>
                          <TableHead className="text-[#8B5CF6]">Type</TableHead>
                          <TableHead className="text-[#8B5CF6]">Amount</TableHead>
                          <TableHead className="text-[#8B5CF6]">Status</TableHead>
                          <TableHead className="text-[#8B5CF6]">Reference</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
            ...
            {/* Right Column with consistent styling */}
            <div className="space-y-6">
              {/* Membership Details */}
              <Card className="bg-[#1E1B21]/80 backdrop-blur-xl border border-[#8B5CF6]/20 rounded-lg shadow-lg">
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Shield className="text-[#8B5CF6]" />
                    <h2 className="text-xl font-semibold bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text text-transparent">
                      Membership Details
                    </h2>
                  </div>
              ...
              <Card className="bg-[#1E1B21]/80 backdrop-blur-xl border border-[#8B5CF6]/20 rounded-lg shadow-lg">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button variant="outline" size="sm" className="bg-black/40 hover:bg-[#8B5CF6]/20 border-[#8B5CF6]/20">
                      Add Member
                    </Button>
                  </div>
              ...
              <Card className="bg-[#1E1B21]/80 backdrop-blur-xl border border-[#8B5CF6]/20 rounded-lg shadow-lg">
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Calendar className="text-[#8B5CF6]" />
                    <h2 className="text-xl font-semibold bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text text-transparent">
                      Announcements
                    </h2>
                  </div>
